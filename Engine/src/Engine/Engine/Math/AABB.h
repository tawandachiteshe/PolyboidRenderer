...
namespace Polyboid
{
	...
	public:
		...
		AABB(const glm::vec3& center, glm::f32 radius);
		...
		void Extend(const glm::vec3& center, glm::f32 radius);
		...
		glm::f32 GetLongestEdge() const;

		/// Retrieves the shortest edge.
		/// If the AABB is NULL, then 0 is returned.
		glm::f32 GetShortestEdge() const;
