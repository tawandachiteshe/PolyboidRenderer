...
namespace Polyboid 
{
	...
	{
		// quadratic shit cherno did. Magic to me as of my understanding....
	...
	{
		if (Input::KeyPressed(KeyCodes::LEFT_ALT))
		{
			...
			if (Input::MousePressed(MouseCodes::BUTTON_MIDDLE))
				MousePan(delta);
			else if (Input::MousePressed(MouseCodes::BUTTON_LEFT))
				MouseRotate(delta);
			else if (Input::MousePressed(MouseCodes::BUTTON_RIGHT))
				MouseZoom(delta.y);
